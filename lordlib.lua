...
function library:Window(name,headercolour,windowcolour) 
    ...
    UiWindow.Parent = LordLib
    UiWindow.BackgroundColor3 = headercolour
    UiWindow.BorderColor3 = headercolour
    ...
    Header.BackgroundColor3 = headercolour
    Header.BorderColor3 = headercolour
    ...
    Minimise.BackgroundColor3 = headercolour
    Minimise.BorderColor3 = headercolour
    ...
    Window.BackgroundColor3 = windowcolour
    Window.BorderColor3 = windowcolour
    ...
    function functions:Button(name, colour, callback)
    ...
    function functions:Label(text, color, textsize)
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleButton.BackgroundColor3 = Window.BackgroundColor3
        ...
        ToggleFiller.BorderColor3 = Window.BackgroundColor3
    ...
    function functions:Box(text, colour, callback)
        local callback = callback or function() end
        ...
        TextBox.BackgroundColor3 = colour
    ...
    function functions:Slider(text, min, max, default, callback)
        ...
        Slider.BackgroundColor3 = Window.BackgroundColor3
        ...
        SilderFiller.BorderColor3 = Window.BackgroundColor3
    ...
    function functions:Dropdown(text, buttons, colour, callback, selective)
        ...
        Dropdown.BackgroundColor3 = colour
        ...
        DropdownFrame.BackgroundColor3 = colour
        DropdownFrame.BorderColor3 = colour
        ...
        function dropFunctions:Button(name)
            ...
            Button_2.BackgroundColor3 = colour
            Button_2.BorderColor3 = colour
    ...
    --- @ Sep
    function functions:Seperator(size)
        sizes[winCount] = sizes[winCount] + size
        Window.Size = UDim2.new(0, 207, 0, sizes[winCount] + 10)

        listOffset[winCount] = listOffset[winCount] + size
        local sep = Instance.new("TextLabel")
        sep.Name = "Seperator"
        sep.Parent = Window
        sep.BackgroundColor3 = Color3.fromRGB(220, 221, 225)
        sep.BackgroundTransparency = 1.000
        sep.BorderColor3 = Color3.fromRGB(27, 42, 53)
        sep.Position = UDim2.new(0, 0, 0, listOffset[winCount])
        sep.Size = UDim2.new(0, 206, 0, size)
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        ColorPickerFrame.BackgroundColor3 = Window.BackgroundColor3
        ColorPickerFrame.BorderColor3 = Window.BackgroundColor3
        ...
        ToggleRGB.BackgroundColor3 = Window.BackgroundColor3
        ...
        ToggleFiller_2.BorderColor3 = Window.BackgroundColor3
        ...
        ClosePicker.BackgroundColor3 = Window.BackgroundColor3
        ClosePicker.BorderColor3 = Window.BackgroundColor3
